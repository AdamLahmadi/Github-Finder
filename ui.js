    ...
    showProfile(user){
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <a href="${user.html_url}" target="_blank" class="btn btn-info mb-4 w-100">View Profile</a>
          </div>
          <div class="col-md-9">
            <span class="badge rounded-pill bg-primary">Public Repos: ${user.public_repos}</span>
            <span class="badge rounded-pill bg-light">Public Gists: ${user.public_gists}</span>
